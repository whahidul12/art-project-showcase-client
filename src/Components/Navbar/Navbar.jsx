        ...
        <div className="dropdown">
          <div tabIndex={0} role="button" className="btn btn-ghost lg:hidden">
            <svg
              ...
              className="text-primary-dark dark:text-primary-light h-5 w-5"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            >
          ...
          <ul
            tabIndex="-1"
            className="menu menu-sm dropdown-content rounded-box bg-card-light dark:bg-card-dark text-primary-dark dark:text-primary-light z-1 mt-3 w-52 p-2 shadow"
          >
            {links}
          </ul>
        </div>
